"""
Combine results with InferSent and our discourse
"""
...
if FLAGS.cluster == "deep":
    ...
    MODEL_PATH = '/home/anie/Documents/cresta/ai/clustering'
else:
...
def batcher(params, batch):
    ...
    embeddings = np.hstack([discourse_embed, infersent_embed])
