"""
PDTB explicit marker prediction
...
class PDTB_EX_Eval(object):
    ...
    def run(self, params, batcher):
        ...
        print metrics.classification_report(y_test, y_test_hat, target_names=dico_label_list)

        logging.debug('Dev acc : {0} Test acc : {1} for PDTB 18 Explicit Prediction \n'.format(devacc, testacc))
